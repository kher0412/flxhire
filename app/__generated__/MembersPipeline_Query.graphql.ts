...
export type MembersPipeline_QueryVariables = {};
export type MembersPipeline_QueryResponse = {
    readonly " $fragmentRefs": FragmentRefs<"MembersList_members">;
};
export type MembersPipeline_Query = {
    readonly response: MembersPipeline_QueryResponse;
    readonly variables: MembersPipeline_QueryVariables;
};
...
return {
  ...
  "params": {
    "cacheID": "58bf1e9e80bda7e7b29384d144f429b1",
    "id": null,
    "metadata": {},
    "name": "MembersPipeline_Query",
    "operationKind": "query",
    "text": "query MembersPipeline_Query {\n  ...MembersList_members\n}\n\nfragment AdminTools_Freelancer on User {\n  id\n  rawId\n  hidden\n  status\n}\n\nfragment FreelancerActions_FreelancerMemberPipelineActionsFragment on User {\n  rawId\n  directChatThreadId\n  firstName\n  lastName\n  avatarUrl\n  lastSeenAt\n  ...AdminTools_Freelancer\n}\n\nfragment FreelancerCardChatButton_Freelancer on User {\n  rawId\n  status\n  directChatThreadId\n  firstName\n  lastName\n  avatarUrl\n  lastSeenAt\n}\n\nfragment FreelancerCardHeader_Freelancer on User {\n  firstName\n  lastName\n  status\n  email\n  lastSeenAt\n  resumeUrl\n  avatarUrl\n  profile {\n    slug\n    id\n  }\n  ...FreelancerCardStatus_Freelancer\n}\n\nfragment FreelancerCardIndustryInfo_Freelancer on User {\n  profile {\n    freelancerType {\n      name\n      id\n    }\n    id\n  }\n}\n\nfragment FreelancerCardLocationInfo_Freelancer on User {\n  profile {\n    city\n    region\n    country\n    fullAddress\n    locationLatitude\n    locationLongitude\n    locationBounds0\n    locationBounds1\n    locationBounds2\n    locationBounds3\n    id\n  }\n}\n\nfragment FreelancerCardSkillsInfo_Freelancer on User {\n  profile {\n    freelancerSubtypes {\n      rawId\n      name\n      id\n    }\n    id\n  }\n  userSkills {\n    experience\n    skill {\n      rawId\n      name\n      id\n    }\n    id\n  }\n}\n\nfragment FreelancerCardSlider_Freelancer on User {\n  rawId\n  firstName\n  video {\n    url\n    posterUrl\n    id\n  }\n}\n\nfragment FreelancerCardStatus_Freelancer on User {\n  status\n  hidden\n  createdAt\n  appliedAt\n}\n\nfragment FreelancerContracts_Contracts on User {\n  hidden\n  profile {\n    slug\n    id\n  }\n  freelancerContracts(first: 5) {\n    edges {\n      node {\n        rawId\n        id\n        hidden\n        lastInteractionAt\n        status\n        previousStatus\n        requestsStatus\n        applicantSource\n        jobApplicationReminderSentAt\n        profileJobIncompatibilityReasons\n        contractRequests {\n          id\n        }\n        job {\n          slug\n          title\n          id\n        }\n        client {\n          firm {\n            name\n            slug\n            id\n          }\n          id\n        }\n        referer {\n          name\n          id\n        }\n      }\n    }\n  }\n}\n\nfragment FreelancerRates_Freelancer on User {\n  firstName\n  profile {\n    clientRate {\n      currency {\n        code\n        id\n      }\n      value\n    }\n    freelancerRate {\n      currency {\n        code\n        id\n      }\n      value\n    }\n    jobTypes\n    availabilityType\n    annualCompensation {\n      currency {\n        code\n        id\n      }\n      value\n    }\n    id\n  }\n}\n\nfragment FreelancerReferences_Freelancer on User {\n  firstName\n  lastName\n  references {\n    name\n    email\n    status\n    relation\n    otherRelation\n    comments\n    id\n  }\n}\n\nfragment Freelancer_FreelancerMemberPipelineFragment on User {\n  rawId\n  firstName\n  hidden\n  profile {\n    slug\n    availableAt\n    id\n  }\n  ...FreelancerCardHeader_Freelancer\n  ...FreelancerCardLocationInfo_Freelancer\n  ...FreelancerCardIndustryInfo_Freelancer\n  ...FreelancerRates_Freelancer\n  ...ShareLinkButton_Freelancer\n  ...FreelancerCardChatButton_Freelancer\n  ...FreelancerCardSkillsInfo_Freelancer\n  ...FreelancerCardSlider_Freelancer\n  ...FreelancerReferences_Freelancer\n  ...FreelancerContracts_Contracts\n}\n\nfragment MembersList_members on Query {\n  members(first: 5) {\n    totalCount\n    edges {\n      node {\n        id\n        ...Freelancer_FreelancerMemberPipelineFragment\n        ...FreelancerActions_FreelancerMemberPipelineActionsFragment\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n\nfragment ShareLinkButton_Freelancer on User {\n  rawId\n  profile {\n    slug\n    id\n  }\n}\n"
  }
};
})();
(node as any).hash = 'd23f94c0d41ed8aadffa92c1446a7072';
export default node;
