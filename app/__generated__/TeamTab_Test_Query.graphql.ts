...
export type TeamTab_Test_QueryVariables = {};
export type TeamTab_Test_QueryResponse = {
...
export type TeamTab_Test_Query = {
    readonly response: TeamTab_Test_QueryResponse;
    readonly variables: TeamTab_Test_QueryVariables;
};
...
return {
  ...
  "params": {
    "cacheID": "79a5d143036dee7d08289627c43aa847",
    "id": null,
    "metadata": {},
    "name": "TeamTab_Test_Query",
    "operationKind": "query",
    "text": "query TeamTab_Test_Query {\n  currentUser {\n    firm {\n      ...TeamTab_Firm\n      id\n    }\n    id\n  }\n}\n\nfragment ContractSettingsDialog_Contract on Contract {\n  id\n  endDate\n  startDate\n  currency {\n    code\n    id\n  }\n  clientRate {\n    currency {\n      code\n      id\n    }\n    value\n  }\n  rateMode\n  freelancerRate {\n    currency {\n      code\n      id\n    }\n    value\n  }\n  enableTimesheets\n  allowManageAccess\n  requireTimesheetApprovalForPayments\n  purchaseOrderNumber\n  isManager\n  isFirmAdmin\n  client {\n    id\n    rawId\n  }\n  bonusPeriod\n  bonusClientRate {\n    currency {\n      code\n      id\n    }\n    value\n  }\n  ...ContractSettingsForm_Contract\n}\n\nfragment ContractSettingsForm_Contract on Contract {\n  id\n  client {\n    self\n    id\n  }\n  freelancer {\n    __typename\n    id\n  }\n  firm {\n    users {\n      id\n      rawId\n      name\n    }\n    id\n  }\n  freelancerFirstName\n  freelancerName\n  freelancerRate {\n    currency {\n      code\n      id\n    }\n    value\n  }\n  rateMode\n  isManager\n  status\n  startDate\n}\n\nfragment FeedbackButton_Contract on Contract {\n  id\n  rawId\n  status\n  positiveFeedbackCount\n  negativeFeedbackCount\n}\n\nfragment FeedbackButton_Freelancer on User {\n  firstName\n  avatarUrl\n}\n\nfragment FreelancerCardChatButton_Contract on Contract {\n  status\n}\n\nfragment FreelancerCardChatButton_Freelancer on User {\n  rawId\n  status\n  directChatThreadId\n  firstName\n  lastName\n  avatarUrl\n  lastSeenAt\n}\n\nfragment FreelancerCardContact_Contract on Contract {\n  freelancerPhone\n  freelancerContactEmail\n  freelancerFirstName\n}\n\nfragment FreelancerCardHeader_Contract on Contract {\n  freelancerFirstName\n  freelancerLastName\n  ...FreelancerCardStatus_Contract\n}\n\nfragment FreelancerCardHeader_Freelancer on User {\n  firstName\n  lastName\n  status\n  email\n  lastSeenAt\n  resumeUrl\n  avatarUrl\n  profile {\n    slug\n    id\n  }\n  ...FreelancerCardStatus_Freelancer\n}\n\nfragment FreelancerCardIndustryInfo_Freelancer on User {\n  profile {\n    freelancerType {\n      name\n      id\n    }\n    id\n  }\n}\n\nfragment FreelancerCardJob_Contract on Contract {\n  status\n}\n\nfragment FreelancerCardLocationInfo_Freelancer on User {\n  profile {\n    city\n    region\n    country\n    fullAddress\n    locationLatitude\n    locationLongitude\n    locationBounds0\n    locationBounds1\n    locationBounds2\n    locationBounds3\n    id\n  }\n}\n\nfragment FreelancerCardSkillsInfo_Freelancer on User {\n  profile {\n    freelancerSubtypes {\n      rawId\n      name\n      id\n    }\n    id\n  }\n  userSkills {\n    experience\n    skill {\n      rawId\n      name\n      id\n    }\n    id\n  }\n}\n\nfragment FreelancerCardStatus_Contract on Contract {\n  status\n  requestsStatus\n  lastInteractionAt\n  invitationType\n}\n\nfragment FreelancerCardStatus_Freelancer on User {\n  status\n  hidden\n  createdAt\n  appliedAt\n}\n\nfragment FreelancerComment_Contract on Contract {\n  freelancerFeedback\n  freelancerMessage\n  status\n  requestsStatus\n}\n\nfragment FreelancerComment_Freelancer on User {\n  firstName\n}\n\nfragment FreelancerInterviewTimes_Contract on Contract {\n  status\n  freelancerTimezoneName\n  freelancerContactEmail\n  interviewSchedulingMethod\n  interviewDate\n  interviewDate1\n  interviewDate2\n  interviewDate3\n}\n\nfragment FreelancerInterviewTimes_Freelancer on User {\n  firstName\n  lastName\n}\n\nfragment FreelancerRates_Contract on Contract {\n  status\n  freelancerFirstName\n  clientRate {\n    currency {\n      code\n      id\n    }\n    value\n  }\n  freelancerRate {\n    currency {\n      code\n      id\n    }\n    value\n  }\n  annualCompensation {\n    currency {\n      code\n      id\n    }\n    value\n  }\n  currency {\n    code\n    id\n  }\n  invitationType\n  availabilityType\n  positionTypes\n  rateMode\n  nextSalaryInvoiceDate\n  dailyFee {\n    currency {\n      code\n      id\n    }\n    value\n  }\n}\n\nfragment FreelancerRates_Freelancer on User {\n  firstName\n  profile {\n    clientRate {\n      currency {\n        code\n        id\n      }\n      value\n    }\n    freelancerRate {\n      currency {\n        code\n        id\n      }\n      value\n    }\n    jobTypes\n    availabilityType\n    annualCompensation {\n      currency {\n        code\n        id\n      }\n      value\n    }\n    id\n  }\n}\n\nfragment ManageFiltersPanel_Firm on Firm {\n  tags {\n    rawId\n    name\n    id\n  }\n  jobs(first: 20) {\n    edges {\n      node {\n        id\n        rawId\n        title\n      }\n    }\n  }\n  skills {\n    rawId\n    name\n    id\n  }\n  ...ManagerFilter_Firm\n}\n\nfragment ManageSidebar_Firm on Firm {\n  ...ManageFiltersPanel_Firm\n}\n\nfragment ManagerFilter_Firm on Firm {\n  ...ManagerSelect_Firm\n}\n\nfragment ManagerSelect_Firm on Firm {\n  users {\n    id\n    rawId\n    name\n  }\n}\n\nfragment ShareLinkButton_Freelancer on User {\n  rawId\n  profile {\n    slug\n    id\n  }\n}\n\nfragment TeamList_Firm on Firm {\n  contracts(first: 5) {\n    totalCount\n    edges {\n      node {\n        rawId\n        ...TeamMember_Contract\n        id\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n  id\n}\n\nfragment TeamMemberActions_Contract on Contract {\n  client {\n    rawId\n    id\n  }\n  id\n  rawId\n  status\n  paymentMode\n  invitationType\n  deletable\n  freelancer {\n    rawId\n    firstName\n    lastName\n    avatarUrl\n    lastSeenAt\n    directChatThreadId\n    id\n  }\n  ...ContractSettingsDialog_Contract\n}\n\nfragment TeamMemberRole_Contract on Contract {\n  isManager\n  isFirmAdmin\n}\n\nfragment TeamMember_Contract on Contract {\n  id\n  rawId\n  paymentsEnabled\n  enableTimesheets\n  freelancerEmail\n  startDate\n  endDate\n  nextSalaryInvoiceDate\n  isManager\n  status\n  client {\n    name\n    firm {\n      tags {\n        rawId\n        name\n        id\n      }\n      id\n    }\n    id\n  }\n  tags {\n    rawId\n    name\n    id\n  }\n  ...FreelancerCardHeader_Contract\n  ...FreelancerCardChatButton_Contract\n  ...FeedbackButton_Contract\n  ...FreelancerComment_Contract\n  ...FreelancerCardContact_Contract\n  ...FreelancerRates_Contract\n  ...FreelancerInterviewTimes_Contract\n  ...FreelancerCardJob_Contract\n  ...TeamMemberActions_Contract\n  ...TeamMemberRole_Contract\n  freelancer {\n    ...FreelancerCardHeader_Freelancer\n    ...FreelancerCardIndustryInfo_Freelancer\n    ...FreelancerCardChatButton_Freelancer\n    ...FeedbackButton_Freelancer\n    ...FreelancerComment_Freelancer\n    ...FreelancerCardLocationInfo_Freelancer\n    ...FreelancerRates_Freelancer\n    ...ShareLinkButton_Freelancer\n    ...FreelancerInterviewTimes_Freelancer\n    ...FreelancerCardSkillsInfo_Freelancer\n    id\n  }\n}\n\nfragment TeamTab_Firm on Firm {\n  ...TeamList_Firm\n  ...ManageSidebar_Firm\n  users {\n    id\n    rawId\n  }\n}\n"
  }
};
})();
(node as any).hash = '9d8ec860db92b269200316b633272a01';
export default node;
