...
export default class FilterIcon extends React.Component<IFilterIconProps, IFilterIconState> {
  ...
  render() {
    return (
      <svg width="72" height="72" viewBox="0 0 81 76" fill="none" style={{ marginRight: 36 }}>
